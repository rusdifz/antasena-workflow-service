...
function makeDeleteWorkflowSetting({ deleteDataWorkflowSetting, internalServer }) {
    return function deleteWorkflowSetting(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield deleteDataWorkflowSetting(bodyparam);
                    // const entityLog:any = {
                    ...
                    //   actionType: 'delete',
                    //   actionDetail: 'Delete Data Workflow Setting',
                    //   actionBeUrl: '/workflow/internal/setting/detail',
                    //   actionBeMethod: 'DELETE'
                    // }
...
exports.default = makeDeleteWorkflowSetting;
