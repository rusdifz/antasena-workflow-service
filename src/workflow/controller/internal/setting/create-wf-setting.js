...
function makeCreateWorkflowSetting({ createDataWorkflowSetting, internalServer }) {
    return function createWorkflowSetting(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield createDataWorkflowSetting(bodyparam);
                    // const entityLog:any = {
                    ...
                    //   actionType: 'create',
                    //   actionDetail: 'Create New Data Workflow Setting',
...
exports.default = makeCreateWorkflowSetting;
