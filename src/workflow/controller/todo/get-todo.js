...
function makeGetTodo({ getDataTodo, internalServer, redisClient }) {
    return function getTodo(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield getDataTodo(bodyparam);
                    const entityLog = {
                        ...
                        screenId: 'Workflow',
                        actionType: 'get',
                        actionDetail: 'Show Data Workflow Todo List',
                        actionBeUrl: '/workflow/todo',
                        actionBeMethod: 'GET'
                    };
