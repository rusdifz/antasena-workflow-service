...
function makeGetStatus({ getDataStatus, internalServer, redisClient }) {
    return function getStatus(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield getDataStatus(bodyparam);
                    const entityLog = {
                        ...
                        screenId: 'Workflow',
                        actionType: 'get',
                        actionDetail: 'Show Data Workflow Status',
                        actionBeUrl: '/workflow/status',
                        actionBeMethod: 'GET'
                    };
